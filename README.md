...
I'm **Shubham Joshi**, a BCA student (Panjab University, Chandigarh) and an aspiring **Java Backend Developer** from Chandigarh, India. I enjoy building backend applications using Java and solving real-world programming problems through clean, maintainable code.

- 🎓 **Education:** Bachelor of Computer Applications (BCA) — 2nd Year
- 🎯 **Career Goal:** Become a skilled Java Backend Developer and contribute to impactful, scalable software systems
- 💡 **Interests:** Building Projects
...
<sub>Java · Java 8 · OOP · Collections Framework · Exception Handling · JDBC</sub>
...
A Java-based console application to manage student academic records with structured, modular logic and persistent data storage.

<img src="https://skillicons.dev/icons?i=java,mysql&theme=dark" height="32" />

**Highlights**
- 📋 Add, update, and delete student records
- 🔍 Search and filter by roll number / name
...
**Description:** Currently building additional backend projects using Java and and MySql.
...
<sub>More backend projects are on the way as I move into Spring Boot and REST APIs 🚧</sub>
...
<img src="https://raw.githubusercontent.com/dev-jshubham/dev-jshubham/output/github-contribution-grid-snake-dark.svg" width="95%" />
